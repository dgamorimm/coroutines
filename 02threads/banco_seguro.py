...
def main():
    ...
    print('Todas as transferências foram concluídas.')
...
def valida_banco(contas: List[Conta], total : int):
    ...
    if atual != total:
        print(f'Erro: o valor atual do banco é BRL$ {atual:.2f} e o valor correto é BRL$ {total:.2f}', flush=True)
    else:
        print(f'Banco OK. Atual: BRL$ {atual:.2f} , Total : BRL$ {total:.2f}', flush=True)
